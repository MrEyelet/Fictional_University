        ...
        <div class="site-footer__col-four">
          ...
          <nav>
            <ul class="min-list social-icons-list group">
              <li><a href="#" class="social-color-facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
  ...
  <div class="search-overlay">
  	<div class="search-overlay__top">
  		<div class="container">
  			...
  			<input type="text" name="" class="search-term" placeholder="What are you looking for?" id="search-terms">
